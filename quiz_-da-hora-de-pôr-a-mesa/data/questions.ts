...
export const quizQuestions: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: "Metáfora", isCorrect: false },
      { id: 'c', text: "Comparação", isCorrect: false },
  ...
  },
  {
    ...
    timeLimit: 20,
    options: [
      { id: 'a', text: "À mãe", isCorrect: false },
      { id: 'b', text: "Ao pai falecido", isCorrect: true },
      { id: 'c', text: "A um irmão ausente", isCorrect: false },
      { id: 'd', text: "A um amigo", isCorrect: false }
    ]
  },
  {
    id: 11,
    ...
    timeLimit: 20,
    options: [
      { id: 'a', text: "Alegria e Euforia", isCorrect: false },
      { id: 'b', text: "Revolta e Ódio", isCorrect: false },
      { id: 'c', text: "Melancolia e Saudade", isCorrect: true },
      { id: 'd', text: "Indiferença", isCorrect: false }
    ]
  }
];